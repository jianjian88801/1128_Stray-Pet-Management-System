        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='chongwu'">
                    <el-form-item class="select" v-if="type!='info'"  label="流浪宠物" prop="chongwuId">
                        <el-select v-model="ruleForm.chongwuId" :disabled="ro.chongwuId" filterable placeholder="请选择流浪宠物" @change="chongwuChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="认领状态" prop="chongwuStatusValue">
                        <el-input v-model="chongwuForm.chongwuStatusValue"
                                  placeholder="认领状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="认领状态" prop="chongwuStatusValue">
                            <el-input v-model="ruleForm.chongwuStatusValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请理由" prop="chongwuText">
                        <el-input type="textarea"  :readonly="ro.chongwuText" v-model="ruleForm.chongwuText" placeholder="申请理由"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwuText" label="申请理由" prop="chongwuText">
                            <span v-html="ruleForm.chongwuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    chongwuText: false,
                    chongwuLingyangYesnoTypes: false,
                    chongwuLingyangYesnoText: false,
                },
                ruleForm: {
                    chongwuId: '',
                    yonghuId: '',
                    chongwuText: '',
                    chongwuLingyangYesnoTypes: '',
                    chongwuLingyangYesnoText: '',
                },
                chongwuLingyangYesnoTypesOptions : [],
                chongwuOptions : [],
                yonghuOptions : [],
                rules: {
                   chongwuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_lingyang_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chongwuLingyangYesnoTypesOptions = data.data.list;
                    }
                });
