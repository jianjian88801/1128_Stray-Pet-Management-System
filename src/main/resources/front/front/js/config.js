...
var centerMenu = [
    ...
    ,{
        name: '商品订单',
        url: '../chongwuyongpinOrder/list.html'
    }
    ,{
        name: '流浪动物救助收藏',
        url: '../liulangdongwujiuzhuCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '流浪动物救助',
        url: './pages/liulangdongwujiuzhu/list.html'
    },
    {
        name: '公告信息',
...
var adminurl =  "http://localhost:8080/liulangcongwuguanli/admin/dist/index.html#/login";
