...
public class LiulangdongwujiuzhuLiuyanView extends LiulangdongwujiuzhuLiuyanEntity implements Serializable {
	...
	public LiulangdongwujiuzhuLiuyanView() {

	}

	public LiulangdongwujiuzhuLiuyanView(LiulangdongwujiuzhuLiuyanEntity liulangdongwujiuzhuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, liulangdongwujiuzhuLiuyanEntity);
