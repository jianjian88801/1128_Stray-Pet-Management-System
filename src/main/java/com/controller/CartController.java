    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                ChongwuyongpinEntity chongwuyongpin = chongwuyongpinService.selectById(cart.getChongwuyongpinId());
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("chongwuyongpin_id", cart.getChongwuyongpinId())
...
//                            cartEntity.setChongwuyongpinId(Integer.valueOf(data.get(0)));   //商品 要改的
