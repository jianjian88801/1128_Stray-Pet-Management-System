        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="认领状态" prop="chongwuStatusTypes">
                        <el-select v-model="ruleForm.chongwuStatusTypes" :disabled="ro.chongwuStatusTypes" placeholder="请选择认领状态">
                            <el-option
                                v-for="(item,index) in chongwuStatusTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="宠物简介" prop="chongwuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwuContent" label="宠物简介" prop="chongwuContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   chongwuContent: [
                              { required: true, message: '宠物简介不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chongwuStatusTypesOptions = data.data.list;
                    }
                });
